...
#Finalmente se hace un modelo que intente predecir el conteo basado en las siguientes características (EN INGLÉS). Hay una manera de no tener que pasar / escribir todas estas variables en la función lm (). Sugerencia: StackOverflow o Google pueden ser más rápidos que la documentación.
