...
# Opcional: ver qué tan bien puede predecir los puntos de datos futuros creando una división de tren / prueba. Pero en lugar de una división aleatoria, su división debería ser datos "futuros" para la prueba.
